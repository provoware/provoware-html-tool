...
ARTIFACT_FILE = ARTIFACT_DIR / "dashboard-dialog-e2e.png"
...
def main() -> int:
    ...
    try:
        ...
        print_step(
            "➡️",
            "Nächster Schritt: python3 -m pip install playwright && python3 -m playwright install chromium",
        )
    ...
    print_step("✅", f"Browser-E2E bestanden: Dialog-Fokusfang geprüft und Artefakt erstellt ({ARTIFACT_FILE}).")
    return 0
